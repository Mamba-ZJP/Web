<script language = javascript>
    ...
    function check_information(){
        ...
        else if(document.form1.norm.value == ""){
            alert("平时成绩不能为空"); return false;
        }
        else if(!check_socre(document.form1.norm.value)){
            alert("平时成绩必须是数字"); return false;
        }
        else if(Number(document.form1.norm.value) < 0 || Number(document.form1.norm.value) > 100){
            alert("平时成绩必须在0~100内"); return false;
        }
        else if(document.form1.exam.value == ""){
            alert("期末成绩不能为空"); return false;
        }
        else if(!check_socre(document.form1.exam.value)){
            alert("期末成绩必须是数字"); return false;
        }
        else if(Number(document.form1.exam.value) < 0 || Number(document.form1.exam.value) > 100){
